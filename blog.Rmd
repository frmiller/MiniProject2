...
## Blog
We analysised the candidates' contributions by commitees in MA, 2012. We selected candidates with positive contributions, and wrote a function to find the proportion of the contribution of one certain candidate to the total contributions to all candidates in MA. 
