...
```{r}
## Join the contribution table and individual table, so that we can see all information about one candidate in one table 
joined <- 
  MA_only %>%
...
## 
```{r}
##find total contributions to candidates in massachusetts
all <- final %>%
