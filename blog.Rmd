...
p1 <- ggplot(no_na, aes(x = cand_name , 
  ...
  scale_fill_manual(values = c("#0000FF", "#FFFF00", "#FF0000"),(guide = guide_legend(title = "Party")))+
  xlab("Candidate Name")+
