...
```{r}
##run the function to find the donations to a certain candidate (Barney Frank)
person_prop(id="H0MA04036")
```

## Blog
We analysised the candidates' contributions by commitees in MA, 2012. We selected candidates with known, positive contributions, and wrote a function to find the proportion of the contribution of one certain candidate to the total contributions to all candidates in MA. 
